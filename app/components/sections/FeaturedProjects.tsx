...
const projects: Project[] = [
    { id: 1, title: "Alpine Modern Villa", location: "Gulmarg, Kashmir", category: "Residential", image: "https://images.pexels.com/photos/1047442/pexels-photo-1047442.jpeg?auto=compress&cs=tinysrgb&w=800" },
    { id: 2, title: "Heritage Restoration", location: "Downtown Srinagar", category: "Restoration", image: "https://images.pexels.com/photos/1366919/pexels-photo-1366919.jpeg?auto=compress&cs=tinysrgb&w=800" },
    { id: 3, title: "Urban Commercial Complex", location: "Residency Road", category: "Commercial", image: "https://images.pexels.com/photos/1563356/pexels-photo-1563356.jpeg?auto=compress&cs=tinysrgb&w=800" },
    { id: 4, title: "Lakeside Resort", location: "Nigeen Lake", category: "Hospitality", image: "https://images.pexels.com/photos/1770809/pexels-photo-1770809.jpeg?auto=compress&cs=tinysrgb&w=800" },
    { id: 5, title: "Eco-Friendly Cottage", location: "Pahalgam", category: "Residential", image: "https://images.pexels.com/photos/1090638/pexels-photo-1090638.jpeg?auto=compress&cs=tinysrgb&w=800" },
];
                ...
                {getSlides().map(({ index, offset }) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <Div className={`absolute bottom-0 left-0 w-full bg-linear-to-t from-black/90 via-black/50 to-transparent p-4 sm:p-6 lg:p-8 text-white transition-opacity duration-500 flex flex-col gap-2 ${isCenter ? "opacity-100" : "opacity-0"}`}>
